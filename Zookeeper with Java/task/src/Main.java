            ...
            if (userInput.equals("exit")) {
                ...
                try {
                    ...
                    if (habitatNumber >= 0 && habitatNumber <= animals.length) {
                        ...
                        System.out.println("Invalid habitat number. Please enter a number between 1 and " + animals.length);
                    }
                } catch (NumberFormatException e) {
                    System.out.println("Invalid input. Please enter a number between 1 and " + animals.length + " or 'exit' to quit.");
                }
            }
